...
const days = [
  ...
  { num: 3, date: "Thu · Jun 4", iso: "2026-06-04", title: "Spring Spa + Seminyak Village + Potato Head Beach Club", type: "sem", badge: "Seminyak", anchor: "Spring Spa 11:30 · Seminyak Village · Potato Head Beach Club dinner", budgetAUD: 230,
    ...
    schedule: [
      ...
      { time: "11:30", icon: "💆", act: "Spring Spa (rooftop) — Deep Tissue 60 min (Nams) + Lymphatic Drainage 60 min (Rebecca) · 30 min foot massage each to follow" },
...
const bookings = [
  ...
  { title: "Book Spring Spa — Jun 4, 11:30", sub: "Deep Tissue 60 min (Nams) + Lymphatic Drainage 60 min (Rebecca) + 30 min foot massage each · Seminyak Village rooftop · WhatsApp +62 813 3862 7222", tag: "urgent" },
  ...
  { title: "Tretinoin cream — for Misha", sub: "Available OTC at Bali apoteks without prescription · ask for Tretinoin 0.025% or 0.05% · ~IDR 30–80k", tag: "pharmacy" },
