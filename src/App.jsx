...
const days = [
  ...
  { num: 3, date: "Thu · Jun 4", iso: "2026-06-04", title: "Svaha Bamboo + Atlas Beach Club", type: "sem", badge: "Seminyak", anchor: "Svaha Bamboo · Local browsing · Atlas Beach Club dinner",
    schedule: [
      { time: "11:00", icon: "💆", act: "Svaha Bamboo Massage — side-by-side (90 min)" },
      { time: "12:30", icon: "🛍", act: "Local browsing / markets · lunch · rest" },
      { time: "16:00", icon: "🏖", act: "Atlas Beach Club — pools, sunset, stay till late" },
      { time: "19:30", icon: "🍽", act: "Dinner at Atlas Beach Club" },
    ] },
...
const dining = [
  ...
  { day: 3, name: "Atlas Beach Club", type: "Pools + sunset + late dinner", cost: "~$80–120", costMid: 100 },
...
const bookings = [
  ...
  { title: "Book Atlas Beach Club dinner — Jun 4, 19:30", sub: "Arrive 16:00 for sunset", tag: "urgent" },
  ...
  { title: "Atlas Beach Club — Jun 4", sub: "Arrive 16:00 · stay till late · dinner there", tag: "anytime" },
...
const driverPlan = [
  ...
  { day: "Jun 4", title: "Half day driver", sub: "Local browsing → Atlas Beach Club (dinner there) · ~$30–40", type: "book", status: "todo", costMid: 35 },
