...
const days = [
  ...
  { num: 3, date: "Thu · Jun 4", iso: "2026-06-04", title: "Spring Spa + Seminyak Village + Potato Head Beach Club", type: "sem", badge: "Seminyak", anchor: "Spring Spa 11:15 (confirmed) · Seminyak Village · Potato Head Beach Club dinner", budgetAUD: 230,
    ...
    schedule: [
      ...
      { time: "11:15", icon: "💆", act: "Spring Spa (rooftop) — Deep Tissue 60 min (Nams) + Lymphatic Drainage 60 min (Rebecca) · 30 min foot massage each to follow" },
...
const bookings = [
  ...
  { title: "Spring Spa — Jun 4, 11:15 — CONFIRMED ✓", sub: "Deep Tissue 60 min (Nams) + Lymphatic Drainage 60 min (Rebecca) + 30 min foot massage each · Seminyak Village rooftop", tag: "done" },
