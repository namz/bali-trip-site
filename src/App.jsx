...
const days = [
  ...
  { num: 6, date: "Sun · Jun 7", iso: "2026-06-07", title: "Tis Cafe + Relaxation", type: "ubu", badge: "Ubud", anchor: "Tis Cafe 10:00 · lunch · swings · pool · free afternoon",
    schedule: [
      { time: "10:00", icon: "☕️", act: "Tis Cafe — lunch, swings, infinity pool (2–3 hrs)" },
      { time: "13:00", icon: "🏊", act: "Return Udaya · relax at private pool · shower" },
  ...
  { num: 7, date: "Mon · Jun 8", iso: "2026-06-08", title: "DADI ATV + Lunch at Udaya + INKA + Sayan House", type: "ubu", badge: "Ubud", anchor: "DADI 08:30 · lunch at Udaya · INKA · Sayan dinner",
    schedule: [
      ...
      { time: "11:30", icon: "🍽", act: "Lunch at The Udaya — in-house" },
...
const driverPlan = [
  ...
  { section: "Ubud" },
  { day: "Jun 7", title: "Tis Cafe morning (10:00) + Kaveri evening", sub: "Simple day · Tis Cafe to Udaya to Kaveri · ~$30–35", type: "book", status: "todo", costMid: 32 },
  { day: "Jun 8", title: "DADI morning (08:30) + INKA afternoon + Sayan House evening", sub: "Gojek to INKA at 13:45 · Depart for Sayan at 18:00 · ~$50–60", type: "book", status: "todo", costMid: 55 },
