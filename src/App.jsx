...
const days = [
  ...
  { num: 3, date: "Thu · Jun 4", iso: "2026-06-04", title: "Spring Spa + Seminyak Village + Potato Head Beach Club", type: "sem", badge: "Seminyak", anchor: "Spring Spa 11:15 (confirmed) · Seminyak Village · Potato Head Beach Club dinner", budgetAUD: 230,
    ...
    venues: [{ name: "Spring Spa Seminyak Village", phone: "6281338627222", maps: "Spring+Spa+Seminyak+Village+Bali" }, { name: "Potato Head Beach Club", phone: "62361473719", maps: "Potato+Head+Beach+Club+Seminyak" }],
    schedule: [
      { time: "11:00", icon: "🛍", act: "Seminyak Village — browse boutiques in AC comfort" },
      { time: "11:15", icon: "💆", act: "Spring Spa (rooftop) — Deep Tissue 90 min (Nams) + Lymphatic Drainage 90 min (Rebecca)" },
      { time: "13:30", icon: "🍽", act: "Lunch at BAKED or Sisterfields · Seminyak Village" },
      { time: "14:30", icon: "🛍", act: "Continue browsing boutiques · rest at hotel" },
      { time: "16:30", icon: "🏖", act: "Potato Head Beach Club — pools, sunset, stay till late" },
  ...
  { num: 7, date: "Mon · Jun 8", iso: "2026-06-08", title: "Gorilla Adventures ATV + Warsa Barber + INKA + Kaveri + Sayan House (Meena & Vishal)", type: "ubu", badge: "Ubud", anchor: "Gorilla ATV 08:30 · Warsa Barber 11:00 · INKA 14:00 · Kaveri 16:30 · Sayan House 18:00 · friends joining", budgetAUD: 390,
    ...
    venues: [{ name: "Gorilla Adventures ATV", phone: "628786225655", maps: "Gorilla+Adventures+ATV+Ubud+Bali" }, { name: "Warsa Barbershop", phone: "6281236755499", maps: "Warsa+Barbershop+Jalan+Monkey+Forest+Ubud" }, { name: "INKA Spa", phone: "6281353966547", maps: "INKA+Spa+Monkey+Forest+Ubud" }, { name: "Kaveri Spa", phone: "62361975668", maps: "Kaveri+Spa+Udaya+Ubud" }, { name: "The Sayan House", phone: "62361978769", maps: "The+Sayan+House+Ubud+Bali" }],
    schedule: [
      ...
      { time: "10:45", icon: "🚗", act: "Driver → Warsa Barbershop, Jl. Monkey Forest (10 min)" },
      { time: "11:00", icon: "✂️", act: "Warsa Barbershop — Hot Towel Shave · Jl. Monkey Forest Ubud · +62 812-3675-5499" },
      { time: "11:45", icon: "🏊", act: "Return Udaya · pool + free time · lunch independently if needed" },
      ...
      { time: "15:30", icon: "🚗", act: "Private driver → The Udaya (15 min)" },
      { time: "16:15", icon: "🚗", act: "Head to Kaveri Spa" },
      { time: "16:30", icon: "💆", act: "Kaveri Spa — 15 min massage" },
      { time: "16:45", icon: "🚗", act: "Private driver → The Sayan House (15 min)" },
      { time: "18:00", icon: "🌿", act: "Arrive Sayan House · explore · settle in · sunset gorge views" },
      { time: "18:30", icon: "🍽", act: "Dinner: The Sayan House — Japanese-Latin fusion · Meena & Vishal joining!" },
    ] },
...
const dining = [
  ...
  { day: 7, name: "The Sayan House", type: "Japanese-Latin fusion · gorge sunset", cost: "~$90–100", costMid: 95, time: "18:00" },
...
const bookings = [
  ...
  { title: "Book Potato Head Beach Club dinner — Jun 4, 19:30", sub: "Arrive 16:30 for sunset", tag: "urgent" },
  ...
  { title: "Potato Head Beach Club — Jun 4", sub: "Arrive 16:30 · stay till late · dinner there", tag: "anytime" },
...
const driverPlan = [
  ...
  { day: "Jun 4", title: "Bluebird · Seminyak Village + Potato Head", sub: "No driver · order Bluebird for both rides · ~$15–20", type: "bluebird", status: "na", costMid: 17 },
